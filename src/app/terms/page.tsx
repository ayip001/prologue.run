    ...
    <>
      ...
      <main className="min-h-screen pt-32 pb-20 dark:bg-slate-950 light:bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="text-4xl font-bold dark:text-white light:text-slate-900 mb-8">Terms of Service</h1>

          <div className="space-y-8 dark:text-slate-300 light:text-slate-600">
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">2. Description of Service</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">3. Use of Content</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">4. Privacy and Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">5. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">6. Changes to Terms</h2>
              <p>
