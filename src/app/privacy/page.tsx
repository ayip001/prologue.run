...
export default function PrivacyPage() {
  return (
    <>
      <Navbar />
      <main className="min-h-screen pt-32 pb-20 dark:bg-slate-950 light:bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="text-4xl font-bold dark:text-white light:text-slate-900 mb-8">Privacy Policy</h1>

          <div className="space-y-8 dark:text-slate-300 light:text-slate-600">
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">1. Information We Collect</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">2. Imagery and Privacy</h2>
              <p>
            ...
            <section className="dark:bg-slate-900/50 light:bg-slate-100 p-6 rounded-xl border dark:border-white/5 light:border-slate-200">
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">3. Content Removal Requests</h2>
              <p className="mb-4">
              ...
              <p className="font-semibold dark:text-white light:text-slate-900 mb-2">To process your request, you must:</p>
            ...
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">4. Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">5. Third-Party Links</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold dark:text-white light:text-slate-900 mb-4">6. Contact Us</h2>
              <p>
